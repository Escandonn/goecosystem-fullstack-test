...
class PatientBase(BaseModel):
    ...
    genero: str = Field(..., max_length=30, description="Género del paciente (Masculino, Femenino, Prefiere no informar)")
    ...
    def validate_genero(cls, v: str) -> str:
        ...
        if v not in ("Masculino", "Femenino", "Prefiere no informar"):
            raise ValueError("El género debe ser 'Masculino', 'Femenino' o 'Prefiere no informar'")
        return v
